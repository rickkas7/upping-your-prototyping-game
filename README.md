...
![Switch Adapter](images/switch-adapter.jpg)
...
![Breadboard with solid wire](images/solidwire1.jpg)

![Breadboard with solid wire](images/solidwire2.jpg)
...
![Solid wires](images/solidwire3.jpg)
...
![Perma-Proto Bottom](images/perma-proto3.jpg)

![Perma-Proto Bottom](images/perma-proto4.jpg)

![Perma-Proto Bottom](images/perma-proto5.jpg)
...
![Feather Prototype Board](images/feather-proto2.jpg)
![Feather Prototype Board](images/feather-proto3.jpg)
...
![Custom PTH board](images/pth-board.png)

I ordered these board from [OshPark](https://oshpark.com). 

![Custom PTH board](images/pth1.jpg)
...
![Custom PTH board](images/pth2.jpg)
...
![SMD board](images/smd1.jpg)

The SMD LED uses different current-limiting resistors but the schematic is otherwise the same.

![SMD schematic](images/smd-schematic.png)

![SMD board in Eagle](images/smd-board.png)
...
![Under-Mount Board](images/under2.jpg)

The schematic is the same, but the Eagle board layout is different:

![Under-Mount Eagle](images/under-board.png)

![Under-Mount Board](images/under1.jpg)

![Under-Mount Board](images/under3.jpg)
...
![Photon Schematic](images/photon-schematic.png)
...
![P1 Schematic](images/p1-schematic.png)

Board 

![P1 Board](images/p1-board.png)
...
![E Series Schematic](images/eseries-schematic.png)

Board:

![E Series Board](images/eseries-board.png)
